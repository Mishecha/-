...
if __name__ == "__main__":
    ...
    nasa_epic_image_directory = os.environ['SPACE_IMAGE_DIRECTORY']
    nasa_image_directory = os.environ['SPACE_IMAGE_DIRECTORY']
    spacex_image_directory = os.environ['SPACE_IMAGE_DIRECTORY']
